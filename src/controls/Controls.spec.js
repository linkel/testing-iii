...
describe('<Controls />', () => {
    it('should call the toggleLocked function passed as prop to unlock gate', () => {
        const { getByText } = render(<Controls locked={true} closed={true} toggleLocked={mock} toggleClosed={mock} />);
